...
_SKIP_CALLS = frozenset({
    ...
    "Println", "Printf", "Fprintf", "Sprintf", "Errorf",
    "Error", "Fatal", "Fatalf", "Log", "Logf",
})
...
class GoSource:
    """Extracts code nodes and edges from Go files."""
    ...
    async def extract(
        ...
        """
        Extract Go AST nodes and edges.
        ...
        for file_path in files:
            ...
            for capture in captures.get("call.site", []):
                ...
                if not containing:
                    continue  # Package-level call — skip
